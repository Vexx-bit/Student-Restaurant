...
$snacks = $conn->query("SELECT meal_id AS id, meal_title AS title, meal_price AS price, meal_img AS img FROM menu WHERE meal_category = 'snack'");
...
if (isset($_GET['add_to_cart'])) {
    ...
    echo "<script>window.open('snacks.php', '_self');</script>";
}
?>
    ...
    <main class="menu-container">
        ...
        <div class="filter-container">
            ...
            <div class="filter-buttons">
                ...
                <button class="filter-button active" data-category="snacks"><a href="snacks.php" style="text-decoration: none;color: inherit;">Snacks</a></button>
        ...
        <h1 class="menu-title">Choose Your Snacks</h1>

        <?php if ($snacks->num_rows > 0): ?>
            <div class="grid-container">
                <?php while ($item = $snacks->fetch_assoc()): ?>
                    <div class="menu-card">
                        <a href="snacks.php?add_to_cart=<?php echo htmlspecialchars($item['id']); ?>" style="text-decoration: none;">
        ...
        <?php else: ?>
            <p class="no-meals-message">Sorry, no snacks are currently available. Please check back later!</p>
        <?php endif; ?>
    </main>
