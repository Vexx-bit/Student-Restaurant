...
$beverage = $conn->query("SELECT meal_id AS id, meal_title AS title, meal_price AS price, meal_img AS img FROM menu WHERE meal_category = 'beverage'");
...
if (isset($_GET['add_to_cart'])) {
    ...
    echo "<script>window.open('beverages.php', '_self');</script>";
}
...
<body>
    <header class="header-menu">
        <nav class="nav-menu">
            ...
            <a href="menu.html" class="nav-link active-link">Menu</a>
    ...
    <main class="menu-container">
        ...
        <div class="filter-container">
            ...
            <div class="filter-buttons">
                ...
                <button class="filter-button active" data-category="beverages"><a href="beverages.php" style="text-decoration: none;color: inherit;">Beverages</a></button>
        ...
        <h1 class="menu-title">Choose Your Beverages</h1>

        <div class="grid-container">
            <?php if ($beverage->num_rows > 0): ?>
                <?php while ($item = $beverage->fetch_assoc()): ?>
                    <div class="menu-card">
                        <a href="beverages.php?add_to_cart=<?php echo htmlspecialchars($item['id']); ?>" style="text-decoration: none;">
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="no-items-message">Sorry, there are no beverages available at the moment. Please check back later!</p>
            <?php endif; ?>
        </div>
    </main>
