...
$groceries = $conn->query("SELECT meal_id AS id, meal_title AS title, meal_price AS price, meal_img AS img FROM menu WHERE meal_category = 'grocery'");
...
if (isset($_GET['add_to_cart'])) {
    ...
    echo "<script>window.open('groceries.php', '_self');</script>";
}
?>
    ...
    <main class="menu-container">
        ...
        <div class="filter-container">
            ...
            <div class="filter-buttons">
                ...
                <button class="filter-button active" data-category="groceries"><a href="groceries.php" style="text-decoration: none;color: inherit;">Groceries</a></button>
            </div>
        </div>
        <h1 class="menu-title">Choose Your Groceries</h1>

        <?php if ($groceries->num_rows > 0): ?>
            <div class="grid-container">
                <?php while ($item = $groceries->fetch_assoc()): ?>
                    <div class="menu-card">
                        <a href="groceries.php?add_to_cart=<?php echo htmlspecialchars($item['id']); ?>" style="text-decoration: none;">
        ...
        <?php else: ?>
            <p class="no-meals-message">Sorry, there are no groceries available at the moment. Please check back later!</p>
        <?php endif; ?>
    </main>
